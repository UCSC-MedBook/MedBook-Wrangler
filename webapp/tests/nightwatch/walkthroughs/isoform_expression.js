module.exports = {
  ...
  "Upload some RectangularIsoformExpression files": function (client) {
    ...
    client
      ...
      .verify.containsText("#review-assay_sample_summary > table > tbody > tr:nth-child(1) > th", "DTB-152")
      .verify.containsText("#review-assay_sample_summary > table > tbody > tr:nth-child(1) > td:nth-child(2)", "Quantile normalized counts")
      .verify.containsText("#review-assay_sample_summary > table > tbody > tr:nth-child(1) > td:nth-child(3)", "25")
      .verify.containsText("#review-assay_sample_summary > table > tbody > tr:nth-child(2) > th", "DTB-156")
      .verify.containsText("#review-assay_sample_summary > table > tbody > tr:nth-child(2) > td:nth-child(2)", "Quantile normalized counts")
      .verify.containsText("#review-assay_sample_summary > table > tbody > tr:nth-child(2) > td:nth-child(3)", "25")
      .verify.containsText("#review-assay_sample_summary > table > tbody > tr:nth-child(3) > th", "DTB-156Pro")
      .verify.containsText("#review-assay_sample_summary > table > tbody > tr:nth-child(3) > td:nth-child(2)", "Quantile normalized counts")
      .verify.containsText("#review-assay_sample_summary > table > tbody > tr:nth-child(3) > td:nth-child(3)", "25")
